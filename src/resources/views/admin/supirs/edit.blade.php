    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.supirs.update", [$supir->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('supirname') ? 'is-invalid' : '' }}" type="text" name="supirname" id="supirname" value="{{ old('supirname', $supir->supirname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('Id_pegawai') ? 'is-invalid' : '' }}" type="text" name="Id_pegawai" id="Id_pegawai" value="{{ old('Id_pegawai', $supir->Id_pegawai) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('umur') ? 'is-invalid' : '' }}" type="text" name="umur" id="umur" value="{{ old('umur', $supir->umur) }}" required>
                @if($errors->has('umur'))
                    <div class="invalid-feedback">
                        {{ $errors->first('umur') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}" type="text" name="jenis_kelamin" id="jenis_kelamin" value="{{ old('jenis_kelamin', $supir->jenis_kelamin) }}" required>
